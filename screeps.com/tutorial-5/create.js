...
var createCreep = {
    ...
    run: function() {
        ...
        if (harvesters.length < harvesters_num) {
            ...
            Game.spawns['中心1'].spawnCreep([WORK, CARRY, MOVE], name, {memory: {role: '采集'}});
        }
        ...
        if (builders.length < builder_num && harvesters.length >= harvesters_num) {
            ...
            Game.spawns['中心1'].spawnCreep([WORK, CARRY, MOVE], name, {memory: {role: '建造'}});
        }
        ...
        if (upgraders.length < upgrader_num && harvesters.length >= harvesters_num) {
            ...
            Game.spawns['中心1'].spawnCreep([WORK, CARRY, MOVE], name, {memory: {role: '升级'}});
        }
    }
}
